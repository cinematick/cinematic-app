        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              ...
              colors: [
                Color(0xFF191B2E).withOpacity(0.85),
                
                Color(0xFF321167).withOpacity(0.65),
              ],
            ),
          ),
          child: Column(
            ...
            children: [
              ...
              Wrap(
                spacing: 8,
                runSpacing: 8,
                children: List.generate(widget.allLanguages.length, (i) {
                  ...
                  return _buildGradientChip(
                    ...
                    onSelected:
                        () =>
                            setState(() => widget.langSelected[i] = !selected),
                  );
                }),
              ),
              SizedBox(height: 25),
              ...
              Wrap(
                spacing: 8,
                runSpacing: 8,
                children: List.generate(widget.allExperiences.length, (i) {
                  final selected = widget.xpSelected[i];
                  return _buildGradientChip(
                    label: widget.allExperiences[i],
                    selected: selected,
                    onSelected:
                        () => setState(() => widget.xpSelected[i] = !selected),
                  );
                }),
              ),
              SizedBox(height: 25),
              ...
              Wrap(
                ...
                children: List.generate(widget.allGenres.length, (i) {
                  ...
                  return _buildGradientChip(
                    ...
                    onSelected:
                        () =>
                            setState(() => widget.genreSelected[i] = !selected),
                  );
                }),
              ),
              Spacer(),
                  ...
                  Expanded(
                    child: OutlinedButton(
                      ...
                      style: OutlinedButton.styleFrom(
                        side: BorderSide(color: Colors.white54, width: 1.6),
